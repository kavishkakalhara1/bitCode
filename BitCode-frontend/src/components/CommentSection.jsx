    ...
    <div className='w-full max-w-2xl p-3 mx-auto'>
      {currentUser ? (
        <div className='flex items-center gap-1 my-5 text-sm text-gray-500'>
          ...
          <Link
            ...
            className='text-xs text-refaa-blue hover:underline'
          >
        ...
        <div className='flex gap-1 my-5 text-sm text-teal-500'>
          ...
          <Link className='text-refaa-blue hover:underline' to={''}>
          {/* <Link className='text-refaa-blue hover:underline' to={'/sign-in'}> */}
            Sign In
          </Link>
        </div>
      )}
      {currentUser && (
        <form
          ...
          className='p-3 border-2 rounded-md border-refaa-blue'
        >
          <Textarea
          ...
          <div className='flex items-center justify-between mt-5'>
            ...
            <Button  className='bg-refaa-red hover:bg-red-800 hover:shadow-xl' type='submit'>
              Submit
            </Button>
          </div>
          {commentError && (
